...
- **Claude** — veri toplama
- **BERTurk (dbmdz/bert-base-turkish-cased)** — duygu analizi (sentiment analysis)
...
2. **Duygu Analizi:** Tweet'lerin pozitif/negatif/nötr olarak sınıflandırılması; Türkçe'ye özgü dil yapısını (ekleme ekler, argo, kısaltmalar) doğal olarak işleyebilen BERT tabanlı bir model kullanılmıştır.
