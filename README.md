...
1. **Manuel küratörlük:** #Galatasaray ve #Galatasaray (hashtag'siz) aramaları X'in "En Yeni" (Latest) sekmesinde yapılmış, alakalı tweetler elle seçilip Google Sheets'e aktarılmıştır.
...
3. **Kalite kontrolü:** Alakasız sonuçlar (farklı dilde, konu dışı, çok eski tarihli tweetler) elle filtrelenmiş; parodi/mizah hesapları (`is_parody` sütunu) ayrıca etiketlenmiştir.
